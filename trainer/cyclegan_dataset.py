...
class NifitDataSet(torch.utils.data.Dataset):
    ...
    def __init__(self, data_path,
        ...
        self.images_list = sorted(glob.glob(os.path.join(data_path, '*_0001.nii.gz')))
        self.labels_list = sorted(glob.glob(os.path.join(data_path, '*_0000.nii.gz')))
    ...
    def __getitem__(self, index):
        ...
        if self.train:
            ...
            label = resize_image_itk(label, newSize=(128, 96, 128), resamplemethod=sitk.sitkLinear)
